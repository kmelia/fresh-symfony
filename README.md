...
Getting started
---------------
**1.** Download or clone the [**latest stable release** [tar.gz]][2] inherited from [Symfony 3.3][3].
...
```
  ...
  [3]: https://github.com/symfony/symfony-standard/tree/3.3 "The Symfony Standard Edition 3.3 release"
